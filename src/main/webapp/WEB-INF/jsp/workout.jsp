...
<body>
  ...
  <div class="col-sm-6">
    <div class="card">
    <img src="static/assets/img/dummies/cardiorun.jpg">
      <div class="card-body">
        <h5 class="card-title">Cardio</h5>
        <p class="card-text">Engage in Activities you love</p>
        <a href="cardio" class="btn btn-primary">Be fit</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
    <img src="static/assets/img/dummies/fullbodybody.jpg">
      <div class="card-body">
        <h5 class="card-title">Full Body Work Outs</h5>
        <p class="card-text">We are committed to making you have that desire shape</p>
        <a href="fullbody" class="btn btn-primary">Lets do this</a>
      </div>
    </div>
  </div>
</div>
