        ...
        <div class="row">
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li class="active">FULL BODY WORKOUT</li>
            </ul>
          </div>
          <div class="span4">
            <div class="search">
             ...
             <div class="span6">
			            <table class="table table-striped table-dark ">
						  ...
						  <tbody>
						    ...
						    <tr>
						      <th scope="row">Incline Dumbbell Bench Press</th>
						      <td>3</td>
						      <td>10</td>
						    </tr>
						    
						    <tr>
						      <th scope="row">One Arm Dumbbell Row</th>
						      <td>3</td>
						      <td>10-15</td>
						    </tr>
						    <tr>
						      <th scope="row">Seated Arnold Press</th>
						      <td>3</td>
						      <td>10-15</td>
						    </tr>
						    <tr>
						      <th scope="row">Cable Tricep Extension</th>
						      <td>3</td>
						      <td>10</td>
						    </tr>
						    <tr>
						      <th scope="row">Barbell Curls</th>
						      <td>3</td>
						      <td>10</td>
						    </tr>
						    <tr>
						      <th scope="row">Leg Curls</th>
						      <td>3</td>
						      <td>12-15</td>
						    </tr>
						 <tr>
						      <th scope="row">Ab Wheel Roll Out</th>
						      <td>3</td>
						      <td>10-15</td>
						    </tr>
             ...
             <div class="span6">
            	        <table class="table table-striped table-dark">
						  ...
						  <tbody>
						    ...
						    <tr>
						      <th scope="row">Bench Press (Ramped)*</th>
						      <td>5</td>
						      <td>5</td>
						    </tr>
						    <tr>
						      <th scope="row">Barbell Row (Ramped)*</th>
						      <td>5</td>
						      <td>5</td>
						    </tr>
						    
						    <tr>
						      <th scope="row">Upright Row</th>
						      <td>3</td>
						      <td>10</td>
						    </tr>
						    <tr>
						      <th scope="row">Skullcrushers</th>
						      <td>3</td>
						      <td>10</td>
						    </tr>
						    <tr>
						      <th scope="row">Dumbbell Curls</th>
						      <td>3</td>
						      <td>10</td>
						    </tr>
						    <tr>
