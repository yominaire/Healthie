      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span3 features e_pulse">
            ...
            <div class="box">
              <div class="divcenter">
                <a href="pancake"><i class="icon-circled icon-48 icon-magic active icon"></i></a>
                <h4>Amazing Coconut pancakes</h4>
              </div>
            </div>
          </div>
          ...
          <div class="span3 features e_pulse">
            ...
            <div class="box">
              <div class="divcenter">
                ...
                <h5>Cinnamon-raisin baked French toast</h5>
              </div>
            </div>
          </div>
          ...
          <div class="span3 features e_pulse">
            ...
            <div class="box">
              <div class="divcenter">
                ...
                <h4>Omelette with fresh Herbs</h4>
              </div>
            </div>
          </div>
          ...
          <div class="span3 features e_pulse">
            ...
            <div class="box">
              <div class="divcenter">
                ...
                <h4>Pomegranate-Berry Smoothie</h4>
              </div>
            </div>
          </div>
          </div>
         ...
         <div class="row"> 
            ...
            <div class="span3 features e_pulse">
            <img src="static/assets/img/dummies/img8.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
                <a href="vegantofu"><i class="icon-circled icon-48 icon-briefcase icon"></i></a>
                <h4>Vegan Mexican Tofu Scamble</h4>
              </div>
            </div>
          </div>
        
         <div class="span3 features e_pulse">
            <img src="static/assets/img/dummies/img6.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
                <a href="coconut"><i class="icon-circled icon-48 icon-bullhorn icon"></i></a>
                <h4>Coconut Lime Quinoa Breakfast Bowl</h4>
              </div>
            </div>
          </div>
              <div class="span3 features e_pulse">
            <img src="static/assets/img/dummies/img5.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
                <a href="#"><i class="icon-circled icon-48 icon-bullhorn icon"></i></a>
                <h4>Bowl of Oatmeal with milk and Berries</h4>
              </div>
            </div>
          </div>
          
          <div class="span3 features e_pulse">
            <img src="static/assets/img/dummies/img7.jpg" alt="" />
            <div class="box">
              <div class="divcenter">
                <a href="greenpepper"><i class="icon-circled icon-48 icon-briefcase icon"></i></a>
                <h4>Green Pepper Tofu Scramble</h4>
              </div>
            </div>
          </div>
        </div>
